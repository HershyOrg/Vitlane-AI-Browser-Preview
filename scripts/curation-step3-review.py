#!/usr/bin/env python3
"""Local Step 3 server: real Managed AI, Shopify fixture, Amazon saved fixture.
...
parser.add_argument("--database-port", default="55438")
parser.add_argument("--database-name", default="vitlane_curation_step3")
parser.add_argument("--port", default="18083")
...
if not os.environ.get("MANAGED_OPENAI_API_SECRET"):
...
os.environ.update(
    ...
    DEV_AUTH_DEFAULT_USER_ID="e5000000-0000-4000-8000-000000000103",
    ...
    MANAGED_RUNNER_ENABLED="true", MANAGED_RUNNER_MODEL_PROVIDER="openai",
...
print(f"Step 3 review: http://127.0.0.1:{args.port} — AI live; Shopify/Amazon stub", flush=True)
