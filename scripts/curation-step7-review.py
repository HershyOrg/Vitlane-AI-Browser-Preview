#!/usr/bin/env python3
"""Local Step 7 server: real Managed AI, Shopify fixture, Amazon saved fixture.
...
parser.add_argument("--database-port", default="15433")
parser.add_argument("--database-name", default="vitlane_curation_step7")
parser.add_argument("--port", default="18117")
...
os.environ.update(
    ...
    BACKGROUND_RESEARCH_ENABLED="true", BACKGROUND_TELEGRAM_ENABLED="true", BACKGROUND_AMAZON_ENABLED="false",
...
print(f"Step 7 review: http://127.0.0.1:{args.port} — AI {'stub' if args.stub_ai else 'live'}; Shopify/Amazon stub; Telegram live, background AI live", flush=True)
